  ...
  return (
    <Layout>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-32 w-full">
          <div
            ref={ref}
            className={`
          ...
          >
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-white/60 text-base md:text-lg max-w-xl mx-auto md:mx-0 mb-8 leading-relaxed">
                ...
                , a full-stack developer specializing in Next.js, React,
                Node.js, Django, and MongoDB — focused on performance, clean
                architecture, and real business results.
              </p>
