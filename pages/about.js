    ...
    >
      <Layout>
        <SEO
          ...
          description="About Emmanuel Ihejirika, a full-stack web developer specialising in scalable web applications, backend systems, and automation."
        />
              ...
              <div className="border border-white/10
                ...
                <div className="flex flex-wrap gap-3">
                  {techStack.map(({ name, icon: Icon }) => (
                    <span
                      key={name}
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/10 text-white/80 text-xs hover:bg-white/20 hover:text-white transition-colors cursor-default"
                    >
                      <Icon size={13} />
                      {name}
                    </span>
